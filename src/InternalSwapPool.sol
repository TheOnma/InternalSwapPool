...
contract InternalSwapPool is BaseHook {
    ...
    function _afterSwap(
        ...
        // Determine the currency that we will be taking our fees in
        ...
        // Calculate a percentage of the swap amount to capture as the fee. For this hook we will take 1% of the value that would be received
